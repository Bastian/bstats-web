...
{#if open}
    <div
        ...
        class="fixed top-0 bottom-0 left-0 z-50 overflow-y-auto text-black bg-white drawer dark:bg-gray-900 dark:text-white"
    >
        <div
    ...
    <div
        ...
        class="fixed top-0 bottom-0 left-0 right-0 z-40 bg-black bg-opacity-60"
    />
{/if}
