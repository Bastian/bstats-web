        ...
        switch (chartType) {
            case 'simple_pie':
                ...
                if (simplePieFilterEnabled) {
                    ...
                    formData.append(
                        'blacklistEnabled',
                        (simplePieFilterMode === 'blacklist').toString()
                    );
                }
                break;
            case 'advanced_pie':
                ...
                if (advancedPieFilterEnabled) {
                    ...
                    formData.append(
                        'blacklistEnabled',
                        (advancedPieFilterMode === 'blacklist').toString()
                    );
                }
                break;
            case 'drilldown_pie':
                ...
                if (drilldownPieFilterEnabled) {
                    formData.append(
                        'filter',
                        JSON.stringify(parseValues(drilldownPieFilterValues))
                    );
                    formData.append('regexEnabled', drilldownPieRegex.toString());
                    formData.append(
                        'blacklistEnabled',
                        (drilldownPieFilterMode === 'blacklist').toString()
                    );
                }
                break;
...
<main class="pb-24">
    {#if !data.canEdit}
        <PageHero>
            ...
            {#snippet content()}
                Only the owner of <span class="font-semibold text-slate-900"
    ...
    {:else}
        <PageHero>
            ...
            {#snippet content()}
                Manage charts, transfers, and cleanup for your plugin. Changes appear instantly on
        ...
        <section class="doc-container mt-12 space-y-8">
            {#if feedbackMessage}
                <div
                    class="rounded-2xl border px-4 py-4 text-sm sm:px-5 sm:py-5 {feedbackType ===
                    'error'
            ...
            <div class="grid gap-8 lg:grid-cols-2">
                ...
                <article class="doc-card space-y-6">
                    ...
                    {#if selectedChartType === 'simple_pie'}
                        <div class="space-y-4 rounded-xl border border-slate-200 bg-slate-50 p-4">
                            <div class="input-group">
                                <label class="input-label" for="chart_title_simple_pie"
                                    >Chart title</label
                                >
                                <input
                            ...
                            {#if simplePieFilterEnabled}
                                ...
                                >
                                    ...
                                    <div class="input-group">
                                        <label class="input-label" for="simplePieFilterMode"
                                            >Filter mode</label
                                        >
                                        <select
                                    ...
                                    <div class="input-group">
                                        <label class="input-label" for="simplePieFilterValues"
                                            >{simplePieFilterMode === 'blacklist'
                                                ? 'Blacklist'
                                                : 'Whitelist'} values</label
                                        >
                                        <textarea
                    ...
                    {#if selectedChartType === 'advanced_pie'}
                        <div class="space-y-4 rounded-xl border border-slate-200 bg-slate-50 p-4">
                            <div class="input-group">
                                <label class="input-label" for="chart_title_advanced_pie"
                                    >Chart title</label
                                >
                                <input
                            ...
                            <div class="input-group">
                                <label class="input-label" for="chart_id_advanced_pie"
                                    >Chart ID</label
                                >
                                <input
                            ...
                            {#if advancedPieFilterEnabled}
                                ...
                                >
                                    <div class="input-group">
                                        <label class="input-label" for="advancedPieMaxValue"
                                            >Max value per slice</label
                                        >
                                        <input
                                    ...
                                    <div class="input-group">
                                        <label class="input-label" for="advancedPieFilterMode"
                                            >Filter mode</label
                                        >
                                        <select
                                    ...
                                    <div class="input-group">
                                        <label class="input-label" for="advancedPieFilterValues"
                                            >{advancedPieFilterMode === 'blacklist'
                                                ? 'Blacklist'
                                                : 'Whitelist'} values</label
                                        >
                                        <textarea
                    ...
                    {#if selectedChartType === 'drilldown_pie'}
                        <div class="space-y-4 rounded-xl border border-slate-200 bg-slate-50 p-4">
                            <div class="input-group">
                                <label class="input-label" for="chart_title_drilldown_pie"
                                    >Chart title</label
                                >
                                <input
                            ...
                            <div class="input-group">
                                <label class="input-label" for="chart_id_drilldown_pie"
                                    >Chart ID</label
                                >
                                <input
                            ...
                            {#if drilldownPieFilterEnabled}
                                ...
                                >
                                    <div class="input-group">
                                        <label class="input-label" for="drilldownPieMaxValue"
                                            >Max value per slice</label
                                        >
                                        <input
                                    ...
                                    <div class="input-group">
                                        <label class="input-label" for="drilldownPieFilterMode"
                                            >Filter mode</label
                                        >
                                        <select
                                    ...
                                    <div class="input-group">
                                        <label class="input-label" for="drilldownPieFilterValues"
                                            >{drilldownPieFilterMode === 'blacklist'
                                                ? 'Blacklist'
                                                : 'Whitelist'} values</label
                                        >
                                        <textarea
                    ...
                    {#if selectedChartType === 'single_linechart'}
                        <div class="space-y-4 rounded-xl border border-slate-200 bg-slate-50 p-4">
                            <div class="input-group">
                                <label class="input-label" for="chart_title_single_linechart"
                                    >Chart title</label
                                >
                                <input
                            ...
                            <div class="input-group">
                                <label class="input-label" for="chart_id_single_linechart"
                                    >Chart ID</label
                                >
                                <input
                            ...
                            <div class="input-group">
                                <label class="input-label" for="line_name_single_linechart"
                                    >Line name</label
                                >
                                <input
                            ...
                            {#if singleLineFilterEnabled}
                                ...
                                >
                                    <div class="input-group">
                                        <label class="input-label" for="singleLineMaxValue"
                                            >Max value</label
                                        >
                                        <input
                                    ...
                                    <div class="input-group">
                                        <label class="input-label" for="singleLineMinValue"
                                            >Min value</label
                                        >
                                        <input
                ...
                <article class="doc-card space-y-4">
                    <div>
                        <h2 class="font-display text-xl font-semibold text-rose-900">
                            Delete plugin
                        </h2>
                    ...
                    <div class="input-group">
                        <label class="input-label" for="confirm_plugin_name"
                            >Type plugin name to confirm</label
                        >
                        <input
