	...
	<section class="doc-container mt-12 space-y-10">
		<article class="doc-card space-y-4">
			...
			<p class="max-w-prose text-sm leading-relaxed text-slate-600">
				bStats is a free metrics service for Minecraft server plugins. When plugin authors integrate
				bStats into their plugins, they can see how many servers use their work, which Minecraft
				versions are popular, and how their plugins are configured.
			</p>
			<p class="max-w-prose text-sm leading-relaxed text-slate-600">
				As a server owner, your server automatically shares basic usage statistics with plugin
				authors when you install plugins that use bStats. This happens in the background and doesn't
			...
			<div class="flex items-start gap-3">
				...
				<div>
					...
					<p class="mt-2 max-w-prose text-sm leading-relaxed text-slate-600">
						...
						and free to use. There's no company behind it, no paid plans, and no intention to monetize
						your data.
					</p>
				</div>
			</div>
		...
		<article class="doc-card space-y-4">
			...
			<p class="max-w-prose text-sm leading-relaxed text-slate-600">
				bStats collects only non-personal, aggregate metrics. We never collect player names, chat
				logs, world data, or any personally identifiable information.
			</p>
			<div class="mt-4 space-y-3">
				...
				<div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:p-5">
					...
					<p class="mt-2 max-w-prose text-sm text-slate-600">
						Some plugins collect custom metrics about how you use their features. For example, a
						plugin might track which configuration options are most popular. This helps authors
		...
		<article class="doc-card space-y-4">
			...
			<div class="mt-4 grid gap-4 md:grid-cols-2">
				<div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:p-5">
					...
					<p class="mt-2 max-w-prose text-sm text-slate-600">
						Seeing real usage statistics encourages plugin authors to continue maintaining and
						improving their plugins. It's incredibly motivating to see thousands of servers using
						your work.
					</p>
				</div>
				<div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:p-5">
					...
					<p class="mt-2 max-w-prose text-sm text-slate-600">
						Authors can see which Minecraft versions are most popular, which features are heavily
						used, and where to focus their development efforts. This leads to better plugins for
						everyone.
					</p>
				</div>
				<div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:p-5">
					...
					<p class="mt-2 max-w-prose text-sm text-slate-600">
						By seeing which server versions and configurations are common, developers can test and
						fix bugs more effectively, improving stability for your server.
					</p>
				</div>
				<div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:p-5">
					<h3 class="flex items-center gap-2 text-sm font-semibold text-slate-700">
					...
					<p class="mt-2 max-w-prose text-sm text-slate-600">
						Many plugin authors maintain their plugins for free. Metrics provide a tangible way to
						show appreciation and validate the time they invest in the community.
					</p>
				</div>
			</div>
		</article>
		...
		<article class="doc-card space-y-4">
			...
			<p class="max-w-prose text-sm leading-relaxed text-slate-600">
				We respect your choice if you prefer not to share metrics. You can disable bStats globally
				for all plugins on your server:
			</p>
			<div class="mt-4 space-y-4">
				<div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:p-5">
					<h3 class="text-sm font-semibold text-slate-700">Step 1: Locate the config file</h3>
					<p class="mt-2 max-w-prose text-sm text-slate-600">
				...
				<div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:p-5">
					...
					<p class="mt-2 max-w-prose text-sm text-slate-600">
						Open the file with any text editor and change <code class="font-mono text-slate-700"
							>enabled</code
						>
			...
			<Accordion.Root class="space-y-3">
				...
				<Accordion.Item title="Can I view what data my server sends?" contentClass="max-w-prose">
					<div class="space-y-4">
						...
						<p>
							You can also enable debug logging in the bStats config file to see the raw data your
							server sends.
						</p>
					</div>
				</Accordion.Item>
