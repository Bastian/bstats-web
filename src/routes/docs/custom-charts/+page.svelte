	...
	<section class="doc-container mt-12 space-y-10">
		<article class="doc-card space-y-4">
			...
			<p class="max-w-prose text-sm leading-relaxed text-slate-600">
				Adding a custom chart consists of two steps: provide the data in your plugin code and
				register the chart on the website.
			</p>
		...
		<article class="doc-card space-y-6">
			<div class="space-y-3">
				...
				<p class="max-w-prose text-sm leading-relaxed text-slate-600">
					Great for categorical data such as configuration options Simple pies track one value per
					server. Advanced pies let you collect multiple values per server.
				</p>
			</div>
