...
<main class="pb-24">
	<PageHero>
		...
		{#snippet content()}
			Common issues and solutions for integrating bStats. If you're still stuck after reading this
			guide, reach out on
			<a
	...
	<section class="doc-container mt-12 space-y-10">
		<article class="doc-card space-y-4">
			...
			<div class="space-y-3">
				...
				<div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:p-5">
					...
					<p class="mt-2 max-w-prose text-sm leading-relaxed text-slate-600">
						The bStats website publishes updates at <strong>hh:00 and hh:30</strong> (every half
						hour). Once data is sent, it may take <strong>up to 30 minutes</strong> to become visible
						on your plugin's dashboard.
					</p>
				</div>
				<div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:p-5">
					<h3 class="text-sm font-semibold text-slate-700">Total time</h3>
					<p class="mt-2 max-w-prose text-sm leading-relaxed text-slate-600">
						In total, expect to wait <strong>3-36 minutes</strong> after server startup before seeing
						your first data point on the dashboard.
					</p>
				</div>
			</div>
		</article>
		...
		<article class="doc-card space-y-4">
			...
			<p class="max-w-prose text-sm leading-relaxed text-slate-600">
				If you've checked everything above and still can't see your data, please reach out for help:
			</p>
