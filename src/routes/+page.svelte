...
<main>
    <!-- Hero -->
    <section class="relative overflow-hidden border-b border-slate-200/60 dark:border-dark-700">
        <div
            class="absolute inset-0 bg-gradient-to-br from-brand-50 via-white to-sky-100 dark:bg-dark-800 dark:bg-none"
        ></div>
        <div
            class="absolute top-[-8rem] left-1/2 h-80 w-80 -translate-x-1/2 rounded-full bg-brand-200/40 blur-3xl dark:hidden"
        ></div>
        <div
            class="absolute right-[-6rem] bottom-[-6rem] h-64 w-64 rounded-full bg-sky-200/50 blur-3xl dark:hidden"
        ></div>
        <div
        ...
        >
            <div class="max-w-2xl">
                <h1
                    class="mt-6 font-display text-4xl font-semibold tracking-tight text-slate-900 sm:text-5xl dark:text-slate-100"
                >
                ...
                <div class="mt-10 flex flex-wrap gap-4">
                    ...
                    <a
                        ...
                        class="mx-auto inline-flex items-center gap-2 text-sm font-semibold text-slate-600 transition hover:text-brand-700 sm:mx-0 dark:text-slate-400 dark:hover:text-brand-400"
                    >
                        Browse plugin list
            ...
            {#if data.spotlightPlugin}
                <div class="relative min-w-0 flex-1">
                    <div
                        class="absolute inset-x-4 top-0 h-24 rounded-3xl bg-white/50 blur-2xl dark:hidden"
                    ></div>
                    <div class="relative mx-auto w-full max-w-xl">
                        <a
                            ...
                            class="block rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl shadow-brand-100/70 transition hover:-translate-y-1 hover:shadow-2xl focus-visible:ring-2 focus-visible:ring-brand-500/60 focus-visible:outline-none dark:border-dark-700 dark:bg-dark-900/50 dark:shadow-none dark:hover:border-dark-600 dark:hover:shadow-lg dark:hover:shadow-black/30"
                        >
                            <div
                                class="flex items-center justify-between text-xs tracking-wide text-slate-500 uppercase dark:text-slate-400"
                            >
                                <span>Plugin spotlight</span>
                                <Badge size="small">Top 100</Badge>
                            </div>
                            <h3
                                class="mt-4 font-display text-2xl font-semibold break-words text-slate-900 dark:text-slate-100"
                            >
                                {data.spotlightPlugin.name}
                            </h3>
                            <p
                                class="mt-2 text-xs tracking-wide break-words text-slate-500 uppercase dark:text-slate-400"
                            >
                                by {data.spotlightPlugin.ownerName}
                            </p>
                            <dl
                                class="mt-5 grid gap-3 rounded-2xl bg-slate-50 p-4 text-sm text-slate-700 sm:grid-cols-2 dark:bg-dark-700/50 dark:text-slate-300"
                            >
                                <div>
                                    <dt
                                    ...
                                    <dd
                                        class="mt-1 font-mono text-lg text-slate-900 dark:text-slate-100"
                                    >
                                ...
                                <div>
                                    <dt
                                        class="text-xs tracking-wide text-slate-500 uppercase sm:col-span-2 sm:mt-3 dark:text-slate-400"
                                    >
                                        Platform
                                    </dt>
                                    <dd
                                        class="mt-1 font-mono text-sm text-slate-900 dark:text-slate-100"
                                    >
    ...
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6">
        <div
            class="relative overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-white to-slate-50 p-8 shadow-xl sm:p-12 dark:border-dark-700 dark:bg-dark-800 dark:bg-none"
        >
            <div class="grid gap-10 xl:grid-cols-2 xl:items-end">
                <div>
                    <Badge>Quick start</Badge>
                    <h2
                        class="mt-5 font-display text-3xl font-semibold text-slate-900 dark:text-slate-100"
                    >
                    ...
                    >
                        <li
                            class="gap-4 rounded-2xl border border-slate-200 bg-white p-5 lg:h-full xl:h-auto dark:border-dark-700 dark:bg-dark-700/50"
                        >
                            <div class="flex gap-4">
                                <div
                                    aria-hidden="true"
                                    class="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-brand-100 font-semibold text-brand-700 dark:bg-dark-700 dark:text-slate-300"
                                >
                                    1
                                </div>
                                <h3
                            ...
                            <div class="mt-4 sm:-mt-1.5 sm:pl-14">
                                <p
                                    class="max-w-prose text-sm leading-relaxed text-slate-600 dark:text-slate-400"
                                >
                ...
                <div class="relative min-w-0">
                    <div
                        class="flex max-w-full flex-col overflow-hidden rounded-2xl border border-slate-200 bg-slate-800 p-5 text-slate-100 shadow-md dark:border-dark-700 dark:bg-dark-700/50"
                    >
                        ...
                        <div
                            class="relative mt-4 max-w-full overflow-x-auto rounded-xl bg-slate-900 px-3 py-4 text-sm leading-relaxed shadow-inner sm:px-5 sm:py-4 dark:bg-dark-900 [&>*]:bg-slate-900! dark:[&>*]:bg-dark-900!"
                        >
    ...
    <!-- Sponsor -->
    <section class="border-t border-slate-200 bg-white dark:border-dark-700 dark:bg-dark-800">
        <div class="mx-auto max-w-6xl px-4 py-16 sm:px-6">
            <div class="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
                ...
                <div>
                    ...
                    <p class="mt-4 text-base leading-relaxed text-slate-600 dark:text-slate-400">
                        Italy's leading game server hosting provider, offering premium Minecraft
                        servers, VPS hosting, and dedicated servers with competitive pricing and
                        exceptional support.
                    </p>
                ...
                <div class="flex items-center justify-center lg:justify-end">
                    ...
                    >
                        <enhanced:img
                            ...
                            alt="GameHosting.it"
                            class="h-full max-h-64 w-auto dark:hidden"
                        />
                        <enhanced:img
                            src="$lib/assets/images/logos/gamehosting-white.png"
                            alt="GameHosting.it"
                            class="hidden h-full max-h-64 w-auto dark:block"
                        />
                    </a>
                </div>
            </div>
    ...
    <!-- Community -->
    <section
        class="relative border-t border-slate-200 bg-white dark:border-dark-700 dark:bg-dark-900"
    >
        <div
            class="absolute inset-0 bg-gradient-to-br from-brand-50 via-white to-slate-100 dark:bg-dark-900 dark:bg-none"
        ></div>
        <div
            class="absolute inset-x-0 top-32 h-72 bg-gradient-to-r from-brand-100/40 via-white to-brand-200/40 blur-3xl dark:hidden"
        ></div>
        <div class="relative mx-auto max-w-6xl px-4 py-20 sm:px-6">
            ...
            <div class="mt-12 grid gap-6 sm:grid-cols-2">
                {#snippet Card(data: {
                    ...
                    >
                        <article
                            class="group relative flex h-full flex-col gap-6 rounded-3xl border border-slate-200 bg-white/80 p-8 shadow-sm backdrop-blur transition duration-200 hover:-translate-y-1 hover:shadow-xl dark:border-dark-700 dark:bg-dark-800"
                        >
                ...
                {#snippet GitHubIcon()}
                    <img
                        alt="GitHub"
                        src={githubIcon}
                        class="size-10 shrink-0 rounded-full sm:size-12 dark:invert"
                    />
                {/snippet}
