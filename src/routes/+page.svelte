        ...
        >
            ...
            {#if data.spotlightPlugin}
                <div class="relative min-w-0 flex-1">
                    <div
                        class="absolute inset-x-4 top-0 h-24 rounded-3xl bg-white/50 blur-2xl"
                    ></div>
                    <div class="relative mx-auto w-full max-w-xl overflow-hidden">
                        ...
                        >
                            ...
                            <p
                                class="mt-2 text-xs tracking-wide break-words text-slate-500 uppercase"
                            >
                            ...
                            >
                                ...
                                <div>
                                    <dt
                                        class="text-xs tracking-wide text-slate-500 uppercase sm:col-span-2 sm:mt-3"
                                    >
                                        Platform
                                    </dt>
