...
<main class="pb-24">
    ...
    <section class="doc-container mt-12">
        <article class="doc-card prose" style="max-width: none">
            ...
            <ul>
                <li>
                    The bStats website (<strong>bStats.org</strong>) and any related subdomains
                    (collectively, the "Site").
                </li>
                <li>
                    The bStats code, including the Metrics class embedded in plugins ("bStats
                    Code").
                </li>
                <li>
                    Any other services, dashboards, or tools provided by bStats (collectively, the
                    "Service").
                </li>
            </ul>
            <p>
                By accessing or using any part of the Service, you agree to be bound by these TOS.
            ...
            <p>
                ...
                plugin code. Nothing in these TOS transfers ownership of any plugin intellectual property
                to bStats.
            </p>
            ...
            <ul>
                <li>
                    Unless explicitly permitted, you must not modify, adapt, or create derivative
                    works of any part of the Metrics class.
                </li>
                <li>
                    Relocation of the Java Metrics class is explicitly permitted, either by manually
                    editing the "package" when using the copy-paste Metrics classes or by using
                    relocation tools when using build tools like Maven or Gradle.
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            Modifying bStats Code to enable support for server software that is not
                            officially supported (e.g., Nukkit) or for client-side use cases (e.g.,
                            Minecraft client plugins).
                        </li>
                        <li>Obfuscation.</li>
                    </ul>
                </li>
            ...
            <ul>
                ...
                <li>
                    bStats reserves the right to investigate and remove any plugins or developers
                    who misuse the Service by collecting personal or otherwise prohibited data.
                </li>
            </ul>
            ...
            <p>
                <strong>Jurisdiction:</strong> You agree that any dispute arising out of or relating
                to these TOS shall be submitted to the exclusive jurisdiction of the competent courts
            ...
            <ul>
                <li>
                    ...
                    <a href="https://github.com/Bastian/bStats" target="_blank">
                        GitHub repository
                    </a>.
                </li>
                <li>
