...
<style>
    .background {
        background-image: url("/patterns/geometry-low-contrast.png");
        ...
        <div class="flex flex-col-reverse md:flex-row">
            ...
            <div class="m-12 rounded md:w-3/5 md:m-0 md:ml-8 xl:mr-16">
                <div class="h-6 bg-gray-200 flex items-center rounded-t-lg">
                    <div class="ml-2 h-2 w-2 rounded-full bg-red-500"></div>
                    <div class="ml-1 h-2 w-2 rounded-full bg-yellow-500"></div>
                    <div class="ml-1 h-2 w-2 rounded-full bg-green-500"></div>
